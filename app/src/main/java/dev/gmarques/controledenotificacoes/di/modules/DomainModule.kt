...
import dev.gmarques.controledenotificacoes.domain.NotificationProcessorImpl
...
abstract class DomainModule {
    ...
    @Binds
    @Singleton
    abstract fun bindNotificationProcessor(impl: NotificationProcessorImpl): NotificationProcessor
}